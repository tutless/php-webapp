...
$sql = "select * from vw_jotrans where transid =".$transid ;
$res = $mycon->query($sql);
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-calendar"></i> Back Job Order</li>
          </ol>
        </section>
			...
			<div class="row">
	            ...
	            <div class="box box-info">
	                <div class="box-header with-border">
	                	<h3 class="box-title" >Back Job Order</h3>
	                	<small></small>	

	                </div><!-- /.box-header -->
	                <div class="box-body">
						        <form id="joform" class="form-horizontal" action="insert-backjoborder.php" method="post">
                        <div class="form-group">
                          <label for="username" class="col-sm-2 control-label">Job Order No.</label>
                          <div class="col-sm-4">
                            <input name="ijonumber" type="text" class="form-control" id="jonumber" value="<?php echo $row['jonumber']; ?>" disabled>
                            <input name="jonumber" type="hidden"  value="<?php echo $row['jonumber']; ?>" >
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="custname" type="text" class="form-control" id="custname" value="<?php echo $row['custname']; ?>" disabled>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="address" type="text" class="form-control" id="address" value="<?php echo $row['address']; ?>" disabled>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="telno" type="text" class="form-control" id="telno" value="<?php echo $row['telno']; ?>" disabled>
                          </div>
                        </div>
                       ...
                       <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <select class="form-control" name="servicetype" disabled>
                          ...
                          <div class="col-sm-4">
                            <select class="form-control" name="warrantyinfo" id="warrantyinfo" disabled>
                        ...
                        <div class="form-group" id="otherinfodiv">
                          ...
                          <div class="col-sm-10">
                            <input name="otherinfo" value="<?php echo $row['otherinfo']; ?>" type="text" class="form-control" id="otherinfo" disabled>
                          </div>
                        </div>
