...
(function ($) {
    ...
    $.extend(Address.prototype, {
        ...
        **/
        value2html: function(value, element) {
            ...
            var html = $('<div>').text(value.street).html() + ' ' + $('<div>').text(value.city).html() + ' ' + $('<div>').text(value.state).html() + ' '+ $('<div>').text(value.zip).html() ; //+ ' ' + $('<div>').text(value.building).html();
            $(element).html(html); 
        },
    ...
    Address.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        tpl: '<div class="editable-address"><label><span>Street: </span><input type="text" name="street" class="input-small"></label></div>'+
             ...
             '<div class="editable-address"><label><span>Zip: </span><input type="text" name="zip" class="input-small"></label></div>', //+
