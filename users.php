    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-dashboard"></i> Edit Users</li>
          </ol>
        </section>
			...
			<div class="row">
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <?php if($row['userid'] != 1){?>
                    <a href="edit-user.php?userid=<?php echo $row['userid']; ?>" class="btn btn-warning btn-xs"> Edit</a> 
                    <a href="delete-user.php?userid=<?php echo $row['userid']; ?>" class="btn btn-danger btn-xs deleteme"> Delete</a> 
                    <?php } ?>
