    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-dashboard"></i> Archived Job Order</li>
          </ol>
        </section>
			...
			<div class="row">
	            ...
	            <div class="box box-info">
	                <div class="box-header with-border">
	                	<h3 class="box-title" > Archived Job Orders</h3>
	                	<small></small>	
                ...
                <th>Actions</th>
						...
						<tbody>
              <?php
                $sql = "SELECT * from vw_jotrans where  repairaction = 'claimed' or repairaction = 'pull out' 
