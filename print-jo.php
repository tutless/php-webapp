...
function Header(){
	...
	$this->Cell(0,0,'Real St., Brgy. 76 Fatima Village, Tacloban City',0,1,'C');	
    $this->Ln(3.5);
    $this->SetFont('Times','',10);
	$this->Cell(0,0,'Telephone No: (053)832-4685 / Mobile Nos: 09219974920(Smart) / 09335168028(Sun) / 09165603210(Globe)',0,1,'C');	
    $this->Ln(3.5);
	$this->Cell(0,0,'Email Add: tac.chronicles@yahoo.com.ph',0,1,'C');	
    $this->Ln(3.5);
    $this->SetFont('Times','B',10);
    ...
    $this->Cell(0,0,'TOSHIBA DEVANT HISENSE HAIER SANYO SKYWORTH PRESTIZ EXTREME MAGIC SING KEVLER CAMEL SPEED QUEEN AVISION',0,1,'C');   
    $this->Ln(3.5);
    $this->SetFont('Times','B',7);
    $this->Cell(0,0,'TCL HYUNDAI XENON PENSONIC ASTRON SAKURA DB AUDIO MINAMI CROWN ITICHE FUKUDA AOC LCD EZY PANATONE KARAVISION PROMAC MYVIEW',0,1,'C');   
