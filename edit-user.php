    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-calendar"></i> Edit User</li>
          </ol>
        </section>
          ...
          <!-- Your Page Content Here -->
			...
			<div class="row">
	            ...
	            <div class="box box-info">
	                ...
	                <div class="box-body">
						        <form id="joform" class="form-horizontal" action="update-user.php" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="password" type="password" class="form-control" id="password" value="<?php echo $row['password']; ?>" required="true">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="nickname" type="text" class="form-control" id="nickname" value="<?php echo $row['nickname']; ?>" required="true">
                          </div>
                        </div>
