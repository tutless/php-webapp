...
$transsql = sprintf("insert into transaction ( transjonumber, transtype, jodate, customerinformed, repairaction, accessories, complain, dealer, datepurchase, labor, transportation, shippingcost, othercharges, checkupfee, discount) Values ( %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", 
	...
	GetSQLValueString($checkupfee,'double'),
	GetSQLValueString($discount,'double')
