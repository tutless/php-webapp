...
$sql = "select MAX(jonumber) as maxno from joborder" ;
$res = $mycon->query($sql);

if($res){
  if($res->num_rows > 0){
      $row = $res->fetch_assoc();
      $maxjonumber = (($row['maxno'] == 0) || ($row['maxno'] < 00000 )  ) ? 90000: $row['maxno'] + 1;
  }
}
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-calendar"></i> New Job Order</li>
          </ol>
        </section>
			...
			<div class="row">
	            ...
	            <div class="box box-info">
	                <div class="box-header with-border">
	                	<h3 class="box-title" >New Job Order</h3>
	                	<small></small>	

	                </div><!-- /.box-header -->
	                <div class="box-body">
						        <form id="joform" class="form-horizontal" action="insert-joborder.php" method="post">
                        <div class="form-group">
                          <label for="username" class="col-sm-2 control-label">Job Order No.</label>
                          <div class="col-sm-4">
                            <input name="jonumber" type="text" class="form-control" id="jonumber" value="<?php echo sprintf( '%05d', $maxjonumber); ?>">
                          </div>
                          <label for="username" class="col-sm-2 control-label">Date</label>
                          <div class="col-sm-4">
                            <input name="jodate" type="text" class="form-control" data-inputmask="'alias': 'mm/dd/yyyy'" value="<?php echo date('m/d/Y');  ?>"  id="jodate" data-mask>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="custname" type="text" class="form-control" id="custname" required="true">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="address" type="text" class="form-control" id="address" required="true">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="telno" type="text" class="form-control" id="telno">
                          </div>
                        </div>
                       ...
                       <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <select class="form-control" name="servicetype">
                              ...
                              <option value="pull-out">Pull Out/Deliver</option>
                            </select>
                          </div>
                          ...
                          <div class="col-sm-4">
                            <select class="form-control" name="warrantyinfo" id="warrantyinfo">
                              <option value="in warranty">In Warranty (1 - 2 Years) </option>
                              <option value="extended warranty">Extended Warranty</option>
                              <option value="dealer unit">Dealer Unit</option>
                              <option value="void warranty">Void Warranty</option>
                              <option value="repeat repair">Repeat Repair/Back Job</option>
                        ...
                        <div class="form-group" id="otherinfodiv">
                          ...
                          <div class="col-sm-10">
                            <input name="otherinfo" type="text" class="form-control" id="otherinfo">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="accessories" type="text" class="form-control" id="accessories">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="complain" type="text" class="form-control" id="complain" required="true">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="repairaction" type="hidden" value="open" id="repairaction" >
                            <input name="raction" type="text" class="form-control" id="raction" value="open" disabled="true">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="dealer" type="text" class="form-control" id="dealer">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="datepurchase" type="text" class="form-control" id="datepurchase" data-inputmask="'alias': 'mm/dd/yyyy'" data-mask>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="partcost" type="text" class="form-control" id="partcost" >
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="labor" type="text" class="form-control" id="labor" >
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="transportation" type="text" class="form-control" id="transportation">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="shippingcost" type="text" class="form-control" id="shippingcost">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="othercharges" type="text" class="form-control" id="othercharges">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <label for="username" class="col-sm-2 control-label">Down Payment</label>
                          <div class="col-sm-10">
                            <input name="downpayment" type="text" class="form-control" id="downpayment">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="checkupfee" type="text" class="form-control" id="checkupfee">
                          </div>
                        </div>
