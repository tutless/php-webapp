    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-dashboard"></i> Daily Payments</li>
          </ol>
        </section>
      ...
      <div class="row">
        <div class="col-md-12">
              <div class="box box-info">
                  ...
                  <div class="box-body">
                    <form class="form-inline" id="frmsearch" action="rep-daily-payments.php" method="post">

                      <div class="form-group">
                        <label for="email"> Date From : </label>
                        <input type="text" class="form-control" data-inputmask="'alias': 'mm/dd/yyyy'" name="datefrom" id="datefrom" data-mask >
                      </div>                      

                      <div class="form-group">
                        <label for="email"> Date To : </label>
                        <input type="text" class="form-control" data-inputmask="'alias': 'mm/dd/yyyy'" name="dateto" id="dateto" data-mask >
                      </div>                      
