    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-dashboard"></i>For Pull Out with Check Up</li>
          </ol>
        </section>
			...
			<div class="row">
	            ...
	            <div class="box box-info">
	                <div class="box-header with-border">
	                	<h3 class="box-title" >For Pull Out with Check Up</h3>
	                	<small></small>	
              ...
              <tr style="font-size: 11px;">
                ...
                <th>Actions</th>
						...
						<tbody>
              <?php
                $sql = 'SELECT * from vw_jotrans where repairaction = "for pull out with check up" 
              ...
              ?>
                <tr style="font-size: 11px;">
                  ...
                  <td>
                    <?php if($balance == 0){ ?>
                    <a href="pull-out.php?transid=<?php echo $row['transid']; ?>" target="_blank" class="btn btn-danger btn-xs claimme"> Pull - Out</a>
                    <?php }else{ ?>
