                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <select name="repairaction" class="form-control">
                              ...
                              <option value="claimed" <?php echo $row['repairaction']=='claimed'? 'selected':'' ; ?>>Claimed</option>
                              <option value="pull out" <?php echo $row['repairaction']=='pull out'? 'selected':'' ; ?>>Pull Out</option>
                              ...
                              <tbody>
                                 ...
                                 ?> 
                                    <tr>
                                      ...
                                      <td><?php echo $modrow['qty'] * $modrow['unitprice']; ?></td>
