...
$sql = "Select * from vw_jotrans where transid =". $_GET['transid'];
			...
			<div class="row">
	            ...
	            <div class="box box-info">
	                <div class="box-header with-border">
	                	<h3 class="box-title" >Edit Job Order : JO #  <?php echo sprintf( '%05d', $row['jonumber']); ?></h3>
	                	<small></small>	
	                ...
	                <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <select name="repairaction" class="form-control">
                              ...
                              <option value="repaired" <?php echo $row['repairaction']=='repaired'? 'selected':'' ; ?>>Repaired</option>
                          ...
                          <input type="hidden" name="cidate" value="<?php echo $row['cidate'] ;?>">
                        </div><!-- form group -->

                        <div class= "form-group">

                          <label for="username" class="col-sm-2 control-label" >Customer Informed/Text</label>
                           <div class="col-sm-4">
                               <select name="customerinformed" class="form-control">
                                 <option value="no" <?php echo $row['customerinformed'] == 'no'? 'selected':''; ?>>No</option>
                                 <option value="yes" <?php echo $row['customerinformed'] == 'yes'? 'selected':''; ?>>Yes</option>
                               </select> 
                            </div>
                          <label for="username" class="col-sm-2 control-label">Date Diagnosed</label>
                          <div class="col-sm-4">
                            <input name="jodiagnosed" type="text" class="form-control" data-inputmask="'alias': 'mm/dd/yyyy'" value="<?php echo ($row['jodiagnosed'] == "1970-01-01")? '' : date('m/d/Y',strtotime($row['jodiagnosed']));  ?>"  id="jodiagnosed" data-mask>
                          </div>
                        ...
                        <div class= "form-group">
                          <!--
                          <label for="username" class="col-sm-2 control-label">Date Start of Repair </label>
                          <div class="col-sm-4">
                            <input name="jorepair" type="text" class="form-control" data-inputmask="'alias': 'mm/dd/yyyy'" value="<?php echo ($row['jorepair'] == "1970-01-01")? '' : date('m/d/Y',strtotime($row['jorepair']));  ?>"  id="jorepair" data-mask>
                          </div>
                        -->
                          <label for="username" class="col-sm-2 control-label">Date Pulled Out</label>
                          <div class="col-sm-4">
                            <input name="jopullout" type="text" class="form-control" data-inputmask="'alias': 'mm/dd/yyyy'" value="<?php echo ($row['jopullout'] == "1970-01-01")? '' : date('m/d/Y',strtotime($row['jopullout']));  ?>"  id="jopullout" data-mask>
                          </div>

                          <label for="username" class="col-sm-2 control-label">Date Repaired </label>
                          <div class="col-sm-4">
                            <input name="jorepaired" type="text" class="form-control" data-inputmask="'alias': 'mm/dd/yyyy'" value="<?php echo ($row['jorepaired'] == "1970-01-01")? '' : date('m/d/Y',strtotime($row['jorepaired']));  ?>"  id="jorepaired" data-mask>
                          </div>
                        ...
                        <div class= "form-group">
                          ...
                          <label for="username" class="col-sm-2 control-label">Date Claimed</label>
                          <div class="col-sm-4">
                            <input name="jodateout" type="text" class="form-control" data-inputmask="'alias': 'mm/dd/yyyy'" value="<?php echo ($row['jodateout'] == "1970-01-01")? '' : date('m/d/Y',strtotime($row['jodateout']));  ?>"  id="jodateout" data-mask>
                          </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-12" >
                            <table class="table table-hover table-bordered table-striped" id="tblrepair">
                              ...
                              <tbody>
                                 <?php 
                                    $modsql = "SELECT * from repairdetail where rdtransid =".$row['transid'];
                                    $result = $mycon->query($modsql);
                                    $mypartstotal = 0;
                                    if($result->num_rows > 0 ){  
                                        $result->data_seek(0);
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="labor" value="<?php echo $row['labor']; ?>" type="text" class="form-control" id="labor">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <label for="username" class="col-sm-2 control-label">Discount</label>
                          <div class="col-sm-10">
                            <input name="discount" value="<?php echo $row['discount']; ?>" type="text" class="form-control" id="discount">
                          </div>
                        </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="checkupfee" value="<?php echo $row['checkupfee']; ?>" type="text" class="form-control" id="checkupfee">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            ...
                            $grandtotal = $row['labor'] + $row['transportation'] + $row['shippingcost'] + $row['othercharges'] + $mypartstotal + $row['checkupfee'] - $row['shippingcost'] ;
                            echo $grandtotal;
                            ?>">
                          </div>
                        </div>
...
//--------------------------  scripts for repair details ---------------------
      ...
      $('#addrepair').click(function(){
        ...
        function getOverallTotal(){
            ...
            $checkupfee = parseFloat($('#checkupfee').val()) || 0;
            $discount = parseFloat($('#discount').val()) || 0;
            
            
            $grandtotal = $labor + $transportation + $shippingcost + $othercharges + $partcost + $checkupfee - $discount; 
