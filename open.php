    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-dashboard"></i> Open</li>
          </ol>
        </section>
          ...
          <!-- Your Page Content Here -->
			...
			<div class="row">
                ...
                <th>Actions</th>
						...
						<tbody>
              <?php
                $sql = "SELECT * from vw_jotrans where repairaction = 'open'  
              ...
              ?>
                <tr style="font-size: 11px;" >
                  ...
                  <td>
                    ...
                    <button data-transid="<?php echo $row['transid']; ?>" type="button" class="btn btn-primary btn-xs diagnosed">Diagnosed</button>
                    <!--
...
$(function () { 
  ...
  $(".diagnosed").click(function(){
    //alert($(this).data('transid'));
    $("#transid").val($(this).data('transid'));
    $("#updatefield").val("jodiagnosed");
    $("#formMode").val("check and diagnose");
