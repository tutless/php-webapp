    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-dashboard"></i> Payments</li>
          </ol>
        </section>
          ...
          <!-- Your Page Content Here -->
			...
			<div class="row">
                ...
                <th>Actions</th>
						...
						<tbody>
              <?php
                $sql = "SELECT * from vw_jotrans  
                ORDER BY jonumber DESC, transid DESC";
              ...
              ?>
                <tr>
                  ...
                  <td><?php
                        $OverallTotal = getOverallTotal($row['transid']); 
                        echo $OverallTotal ; 
                      ?>
                    
                  </td>                 
                  <td><?php 
                        $payments = getPayments($row['transid']);
                        echo $payments ; 
                      ?>
                  </td> 
                  <td><?php
                  ...
                  <td>
                    <a href="pay-details.php?transid=<?php echo $row['transid']; ?>" class="btn btn-success btn-xs"> View</a>
                    <?php if($balance > 0){ ?>
