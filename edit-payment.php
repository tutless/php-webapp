    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-calendar"></i> Edit Payment</li>
          </ol>
        </section>
          ...
          <!-- Your Page Content Here -->
			...
			<div class="row">
	            ...
	            <div class="box box-info">
	                ...
	                <div class="box-body">
                    <h3>Available Balance : <span style="color:red;" id="mybalance"><?php echo ($balance + $row['payamount']) ; ?></span></h3>
						        <form id="payform" class="form-horizontal" action="update-payment.php" method="post">
                        <input type="hidden" name="transid" value="<?php echo $transid; ?>" >

                        <div class="form-group">
                          <label for="username" class="col-sm-2 control-label">Payment Id</label>
                          <div class="col-sm-10">
                            <input name="ipaymentid" type="text" class="form-control" id="paymentid" value="<?php echo $row['paymentid']; ?>" >
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="article" type="text" class="form-control" id="article" required="true" value="<?php echo $row['article']; ?>">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input name="payamount" type="text" class="form-control" id="amount" required="true" value="<?php echo $row['payamount']; ?>">
                          </div>
                        </div>
