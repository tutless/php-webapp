    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-dashboard"></i> Back Job</li>
          </ol>
        </section>
			...
			<div class="row">
	            ...
	            <div class="box box-info">
	                <div class="box-header with-border">
	                	<h3 class="box-title" >Back Job</h3>
	                	<small></small>	
                ...
                <th>Actions</th>
						...
						<tbody>
              <?php
                $sql = "SELECT * from vw_mtalljounit where repairaction = 'claimed'   
                ORDER BY transjonumber DESC";
              ...
              ?>
                <tr>
                  ...
                  <td><?php echo date('m/d/Y',strtotime($row['jodateout'])); ?></td> 
                  <td><?php echo $row['repairaction']; ?></td>
                  <td>
                    <a href="add-backjob-order.php?transid=<?php echo $row['transid']; ?>" class="btn btn-info btn-xs">Open</a> 
