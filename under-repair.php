    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-dashboard"></i> Check and Repair </li>
          </ol>
        </section>
			...
			<div class="row">
	            ...
	            <div class="box box-info">
	                <div class="box-header with-border">
	                	<h3 class="box-title" > Check and Repair </h3>
	                	<small></small>	
                ...
                <th>Actions</th>
						...
						<tbody>
              <?php
                $sql = 'SELECT * from vw_jotrans where repairaction = "check and repair" 
              ...
              ?>
                <tr>
                  ...
                  <td><?php echo date('m/d/Y',strtotime($row['jorepair'])); ?></td> 
                  <td><?php 
                      $date1 = new DateTime($row['jorepair']);
                  ...
                  <td>
                    <a href="pull-out.php?transid=<?php echo $row['transid']; ?>" target="_blank" class="btn btn-danger btn-xs pullme"> Pull Out</a>
                  </td>              
                </tr>
              <?php 
                  } 
